...
public class ResultUtil<T> {
    ...
    /**
     * Phương thưc khởi tạo, đặt giá trị mặc định cho kết quả phản hồi
     */
    public ResultUtil() {
    ...
    /**
     * Phương thức tính trừu tượng, trả về tập kết quả
     *
     * @param t Kiểu dữ liệu
     * @return Thông báo
     */
     ...
     * Trả về thành công
     *
     * @param responseStatusCode Mã trạng thái trả ề
     * @return Thông báo
     */
