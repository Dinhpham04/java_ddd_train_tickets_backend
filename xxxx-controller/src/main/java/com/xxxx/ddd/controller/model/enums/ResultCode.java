...
public enum ResultCode {
     ...
     */
    // Khởi tạo các hằng số trong enum
    // Thực chất mỗi hằng số là một instance của class
    // Không thể sử dụng các giá trị ngoài các giá trị đã khởi tạo
    ...
    // code và message là hằng số, không thay đổi
